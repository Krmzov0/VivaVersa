    ...
    return (
        <div className='relative bottom-0  flex flex-col w-screen h-max py-20  pb-8 px-6 sm:px-12 bg-[#17191b]'>
            <div className='flex w-full flex-col sm:flex-row justify-between items-start gap-y-4 sm:gap-y-0 sm:items-center'>
                <h1 className='unbounded text-[24px] sm:text-[30px] font-light text-[#f1f2ee]'>DON’T LET YOUR IDEA STAY A DREAM. de</h1>
                <Image
                    className='flex w-20'
                    src="/WhiteLogo.svg"
                    width={10}
            ...
            <div className='mt-10 sm:mt-14' >
                <div className='flex sm:items-center flex-col justify-start items-start sm:flex-row gap-y-[20px] gap-x-0 sm:gap-y-0 sm:gap-x-[20px]'>
                    <div className='flex flex-row gap-x-[20px] '>
                        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} ><h4 className='unbounded text-lg sm:text-[15px] font-light hover:text-[#878c8e] transition-all cursor-pointer text-[#f1f2ee]' onClick={() => router.push("/de/home")}>Home</h4></motion.div>
                        <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} ><h4 className='unbounded text-lg sm:text-[15px] font-light hover:text-[#f1f2ee] transition-all cursor-pointer text-[#878c8e]' onClick={() => router.push("/de/about")}>About</h4></motion.div>
                    </div>

                    <div className='flex flex-row gap-x-[20px] '>
                        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} ><h4 className='unbounded text-lg sm:text-[15px] font-light hover:text-[#878c8e] transition-all cursor-pointer text-[#f1f2ee]' onClick={() => router.push("/de/services")}>Services</h4></motion.div>
                        <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} ><h4 className='unbounded text-lg sm:text-[15px] font-light hover:text-[#f1f2ee] transition-all cursor-pointer text-[#878c8e]' onClick={() => router.push("/de/contact")}>Contact</h4></motion.div>
                    </div>
                </div>
            </div>
        </div>
