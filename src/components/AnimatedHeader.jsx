    ...
    return (
        <div className='flex h1div flex-col justify-center items-center text-center'>
            <div className="flex items-center gap-x-2 md:gap-x-6">
                <div className='h1class transition-all flex  justify-center items-center leading-[50px] md:leading-[65px] xl:leading-[90px] text-4xl md:text-5xl xl:text-7xl duration-300 text-[#17191b] text-center unbounded font-light'>
            ...
            <div className="flex md:hidden items-center gap-x-2 md:gap-x-6">
                <div className='h1class transition-all flex md:hidden  justify-center items-center leading-[50px] md:leading-[65px] xl:leading-[90px] text-4xl md:text-5xl xl:text-7xl duration-300 text-[#17191b] text-center unbounded font-light'>
            ...
            <div className="flex items-center gap-x-2 md:gap-x-6">
                <div className='h1class transition-all hidden md:flex  justify-center items-center leading-[50px] md:leading-[65px] xl:leading-[90px] text-4xl md:text-5xl xl:text-7xl duration-300 text-[#17191b] text-center unbounded font-light'>
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.40 }}>F</motion.div>
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.44 }}>O</motion.div>
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.48 }}>R</motion.div>
                </div>
