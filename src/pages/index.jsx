        ...
        <div className="h-max sm:h-max relative w-screen p-8 sm:p-12 pb-28 sm:pb-44 sm:pr-16 flex flex-col justify-center">
          ...
          <div className="mt-14">
            <div className="unbounded text-[16px] hidden sm:flex  sm:text-[#17191b] gap-y-10 text-[#878c8e] sm:text-4xl font-light flex-col">
              ...
              <div className="overflow-hidden">
                <motion.div initial={{ y: "100%" }} whileInView={{ y: 0 }} transition={{ ease: [0.6, 0.01, -0.05, 0.95], duration: 0.7, delay: 0.1 }}><h1 className="overflow-hidden"> - IT&apos;S ABOUT CRAFTING SOLUTIONS THAT GIVE YOU A</h1></motion.div>
              </div>
              <div className="overflow-hidden">
          ...
          <div>
            <div>
              <div className="border-[#f1f2ee]">
                <h1 className="text-2xl sm:text-[32px] text-[#f1f2ee] unbounded font-light hover:font-light sm:hover:font-medium transition-all duration-300 gap-x-4 flex items-center"><span className="text-[#878c8e]">01</span> SOCIAL MEDIA MARKETING</h1>
                <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} transition={{ ease: [0.6, 0.01, -0.05, 0.95], duration: 0.7, delay: 0.1 }} className="origin-left w-full h-[2px] bg-[#f1f2ee] my-10"></motion.div>
              </div></div>

            <div><div className=" border-[#f1f2ee]">
              <h1 className="text-2xl sm:text-[32px] text-[#f1f2ee] unbounded font-light hover:font-light sm:hover:font-medium transition-all duration-300 gap-x-4 flex items-center"><span className="text-[#878c8e]">02</span> WEB DESIGN</h1>
              <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} transition={{ ease: [0.6, 0.01, -0.05, 0.95], duration: 0.7, delay: 0.1 }} className="origin-left w-full h-[2px] bg-[#f1f2ee] my-10"></motion.div>
            </div></div>

            <div><div className=" border-[#f1f2ee]">
              <h1  className="text-2xl sm:text-[32px] text-[#f1f2ee] unbounded font-light hover:font-light sm:hover:font-medium transition-all duration-300 gap-x-4 flex items-center"><span className="text-[#878c8e]">03</span> WEB DEVELOPMENT</h1>
              <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} transition={{ ease: [0.6, 0.01, -0.05, 0.95], duration: 0.7, delay: 0.1 }} className="origin-left w-full h-[2px] bg-[#f1f2ee] my-10"></motion.div>
            </div></div>
          </div>
        </div>
