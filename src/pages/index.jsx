  ...
  return (
    <>
      ...
      <div className="">
        ...
        <div className="p-6 sm:p-12 sm:pt-0 w-screen h-full flex ">
        ...
        <div className="h-max sm:h-max relative w-screen p-6 sm:p-12 pb-28 sm:pb-44 sm:pr-16 flex flex-col justify-center">
          ...
          <div className="mt-10">
            <div className=" text-[16px] hidden sm:flex  sm:text-[#17191b] gap-y-10 text-[#878c8e] sm:text-4xl font-light flex-col">
            ...
            <div className=" text-[16px] flex sm:hidden  sm:text-[#17191b] gap-y-2 text-[#878c8e] sm:text-4xl font-light flex-col">
              ...
              <div className='overflow-hidden'><motion.div initial={{ y: "100%" }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }}><h1 className="overflow-hidden">THAT GIVE YOU A COMPETITIVE</h1></motion.div></div>
              <div className='overflow-hidden'><motion.div initial={{ y: "100%" }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }}><h1 className="overflow-hidden">EDGE BY ENHANCING CONVERSION</h1></motion.div></div>
              <div className='overflow-hidden'><motion.div initial={{ y: "100%" }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }}><h1 className="overflow-hidden">RATES, USER ENGAGEMENT,</h1></motion.div></div>
              <div className='overflow-hidden'><motion.div initial={{ y: "100%" }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }}><h1 className="overflow-hidden">AND BRAND PERCEPTION</h1></motion.div></div>
          ...
          <div>
            <div>
              <div className="border-[#f1f2ee]">
                <h1 className="text-2xl sm:text-[32px] text-[#f1f2ee]  font-light hover:font-light sm:hover:font-medium transition-all duration-300 gap-x-4 flex items-center"><span className="text-[#878c8e]">01</span> SOCIAL MEDIA MARKETING</h1>
                <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: '100%' }} transition={{ ease: [0.6, 0.01, -0.05, 0.95], duration: 0.7 }} className="origin-left w-full h-[2px] bg-[#f1f2ee] my-10"></motion.div>
              </div>
            </div>

            <div>
              <div className=" border-[#f1f2ee]">
                <h1 className="text-2xl sm:text-[32px] text-[#f1f2ee]  font-light hover:font-light sm:hover:font-medium transition-all duration-300 gap-x-4 flex items-center"><span className="text-[#878c8e]">02</span> WEB DESIGN</h1>
                <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: '100%' }} transition={{ ease: [0.6, 0.01, -0.05, 0.95], duration: 0.7 }} className="origin-left w-full h-[2px] bg-[#f1f2ee] my-10"></motion.div>
              </div>
            </div>
            ...
            <div>
              <div className=" border-[#f1f2ee]">
                <h1 className="text-2xl sm:text-[32px] text-[#f1f2ee]  font-light hover:font-light sm:hover:font-medium transition-all duration-300 gap-x-4 flex items-center"><span className="text-[#878c8e]">03</span> WEB DEVELOPMENT</h1>
                <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: '100%' }} transition={{ ease: [0.6, 0.01, -0.05, 0.95], duration: 0.7 }} className="origin-left w-full h-[2px] bg-[#f1f2ee] my-10"></motion.div>
              </div>
            </div>
          </div>
