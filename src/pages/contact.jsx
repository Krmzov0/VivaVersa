        ...
        <form className='z-[30] mt-12 w-full md:w-[50%]  flex flex-col gap-y-8' onSubmit={handleSubmit}>
          ...
          <div className='flex flex-col md:flex-row gap-y-8 md:gap-y-0 items-start w-full gap-x-6'>
            <div className='flex flex-col w-full gap-y-3'>
              ...
              <input required value={formData.fullName}
                onChange={handleChange} name='fullName' type="text" autoComplete='off' className='outline-none rounded-none hover:border border-[#17191b] py-4 text-[#17191b] px-3 font-light bg-[#878c8e27]' placeholder='Full Name' />
            </div>
            ...
            <div className='flex flex-col w-full gap-y-3'>
              ...
              <input required value={formData.email}
                onChange={handleChange} name='email' type="text" autoComplete='off' className='outline-none rounded-none hover:border border-[#17191b] py-4 text-[#17191b] px-3 font-light bg-[#878c8e27]' placeholder='Email Address' />
            </div>
          </div>
          ...
          <div className='flex flex-col w-full gap-y-3'>
            ...
            <input required value={formData.goal}
              onChange={handleChange} name='goal' type="text" autoComplete='off' className='outline-none rounded-none hover:border border-[#17191b] py-4 text-[#17191b] px-3 font-light bg-[#878c8e27]' placeholder='Your Goal' />
          </div>
          ...
          <motion.div transition={{ type: "spring", stiffness: 130, duration: 0.1 }}  initial={{ scale: 1 }} whileHover={{scale: 1.02}} whileTap={{y: 2.5}}>
            <button className='bg-[#17191b] flex w-full py-4 font-light text-[#f1f2ee] justify-center'>{loading ? (<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className='w-max flex items-center gap-x-3'>Sending <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
